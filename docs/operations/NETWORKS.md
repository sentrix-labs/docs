...
| Binary | Latest release — see [github.com/sentrix-labs/sentrix/releases/latest](https://github.com/sentrix-labs/sentrix/releases/latest) |
...
post tokenomics-v2 fork at h=381651, on the same binary as mainnet.
